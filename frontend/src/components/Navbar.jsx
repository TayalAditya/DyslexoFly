    ...
    <nav className="bg-white shadow-md">
            ...
            <Link href="/" className="flex-shrink-0 flex items-center">
              <div className="flex flex-col">
                <div className="flex items-center">
                  <span className="text-2xl font-bold text-purple-600">Dyslexo</span>
                  <span className="text-2xl font-bold text-blue-500">Fly</span>
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-blue-400 ml-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 19l9 2-9-18-9 18 9-2zm0 0v-8" />
                  </svg>
                </div>
                <span className="text-xs italic text-gray-600">Words take flight, reading feels right!</span>
              </div>
            </Link>
      ...
      <div className={`md:hidden ${mobileMenuOpen ? 'block' : 'hidden'}`}>
        <div className="pt-2 pb-3 space-y-1">
          ...
          <Link href="/upload" className="block pl-3 pr-4 py-2 border-l-4 border-transparent text-base font-medium text-gray-600 hover:bg-gray-50 hover:border-gray-300 hover:text-gray-800">
            Upload
          </Link>
