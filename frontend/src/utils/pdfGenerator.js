...
export const generateDyslexoFlyPDF = (fileId, textContent, summaries, audioUrl) => {
  ...
  yPosition = addWrappedText('Team: The Kamand Crew', margin, yPosition, contentWidth, 12, primaryColor);
  ...
  for (let i = 1; i <= pageCount; i++) {
    ...
    doc.text(`© ${new Date().getFullYear()} The Kamand Crew | Making education accessible for everyone`, pageWidth - margin - 120, doc.internal.pageSize.height - 10);
  }
