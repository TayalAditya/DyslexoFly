        ...
        <div className="bg-white/90 backdrop-blur-sm rounded-2xl shadow-xl overflow-hidden border border-indigo-100">
          <div className="p-6 md:p-8">
            <section className="mb-8">
              ...
              </p>              <div className="bg-gradient-to-r from-indigo-50 to-purple-50 p-4 rounded-lg border border-indigo-100">
                <p className="text-indigo-700 text-sm italic">
                  &ldquo;We envision a world where learning materials adapt to students, not the other way around.&rdquo;
                </p>
              </div>
            </section>
            ...
            <section>
              <div className="flex items-center mb-4">
                ...
                We&rsquo;re constantly working to improve DyslexoFly and expand our capabilities. 
                If you&rsquo;re interested in contributing to this project or have suggestions for improvement, 
                please contact us.
              </p>
